...
int container_hostdir_zero_rddir(
...
int container_num_host_dirs(int *hostdir_count,char *target, void *vback, char *bm);
...
int container_parindexread_merge(
...
int container_protect(const char *logical, pid_t pid);
