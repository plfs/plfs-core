...
def generateGraphs(times, bandwidths, iosTime, iosFin, writeBins,\
    ...
    if processorGraphs:
        input = [(bandwidthGraphs, times, bandwidths, iosTime, iosFin, None, \
            hostdirs, sizes, None, None, None, None, None, "-Bandwidths"), \
            (networkGraph, None, None, None, None, None, hostdirs, None, None, \
             None, None, None, None,"-Network"), \
            (barGraph, None, None, None, None, writeBins, hostdirs, None, None,\
             None, None, None, None, "-WriteSizes"), \
            (graphPerProcessor, None, None, None, None, None, hostdirs, None, \
            mpiFile, average, jobID, above, below, "-Processors")]
    else:
        input = [(bandwidthGraphs, times, bandwidths, iosTime, iosFin, None, \
            hostdirs, sizes, None, None, None, None, None, "-Bandwidths"), \
            (networkGraph, None, None, None, None, None, hostdirs, None, None, \
